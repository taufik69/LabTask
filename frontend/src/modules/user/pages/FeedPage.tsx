                ...
                <div className="_header_nav_profile">
                  ...
                  <div className="_header_nav_dropdown">
                    ...
                    <button
                      ...
                      type="button"
                      onClick={() => setIsDropShow(!isDropShow)}
                    >
                      ...
                      <div className="_feed_inner_text_area  _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
                        <div className="_feed_inner_text_area_box">
                          ...
                          <div className="form-floating _feed_inner_text_area_box_form ">
                            ...
                            ></textarea>
                            <label className="_feed_textarea_label" htmlFor="floatingTextarea" onClick={() => setShowCreatePostModal(true)}>Write something ...
                        ...
                        <div className="_feed_inner_text_area_bottom">
                          <div className="_feed_inner_text_area_item">
                            <div className="_feed_inner_text_area_bottom_photo _feed_common">
                              <button type="button" className="_feed_inner_text_area_bottom_photo_link" onClick={() => setShowCreatePostModal(true)}> <span className="_feed_inner_text_area_bottom_photo_iamge _mar_img"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
